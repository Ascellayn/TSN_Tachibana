	...
	Entries: TUI.Menu.Entries = [
		...
		TUI.Menu.Entry(20, ""),
			TUI.Menu.Entry(20, "Per-Protocol Settings", Bold=True, Indentation=1),
				...
				TUI.Menu.Entry(11, "SSH Binary", "Specify the executable to use when attempting to create SSH Connections.", Value="/usr/sbin/ssh", Indentation=1, ID="Server_SSH_Binary_SSH"),
				TUI.Menu.Entry(11, "SSHFS Binary", "Specify the executable to use when attempting to mount SSHFS Connections.", Value="/usr/sbin/sshfs", Indentation=1, ID="Server_SSH_Binary_SSHFS"),
		TUI.Menu.Entry(20, ""),
