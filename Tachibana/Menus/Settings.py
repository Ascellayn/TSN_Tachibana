	...
	Entries: TUI.Menu.Entries = [
		...
		TUI.Menu.Entry(20, ""),
			TUI.Menu.Entry(20, "Per-Protocol Settings", Bold=True, Indentation=1),
				...
				TUI.Menu.Entry(11, "SSH Binary", "Specify the executable to use when attempting to create SSH Connections.", Indentation=1, ID="Server_SSH_Binary_SSH", Value=Safe.Nested_Dict(cast(dict[str, Any], Tachibana["Config"]), ["Servers", "SSH", "Binary_SSH"], "/bin/ssh"), Required=True),
				TUI.Menu.Entry(11, "SSHFS Binary", "Specify the executable to use when attempting to mount SSHFS Connections.", Indentation=1, ID="Server_SSH_Binary_SSHFS", Value=Safe.Nested_Dict(cast(dict[str, Any], Tachibana["Config"]), ["Servers", "SSH", "Binary_SSHFS"], "/bin/sshfs"), Required=True),
		TUI.Menu.Entry(20, ""),
